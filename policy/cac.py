...
class CAC_Approximation(Base):
    def __init__(
        ...
        super(CAC_Approximation, self).__init__()

        # constants
        self.name = "CAC_Approximation"
        self.device = device
        ...
        self.ppo_lr_scheduler = LambdaLR(self.ppo_optimizer, lr_lambda=self.ppo_lr_fn)

...
![cac_logo](https://github.com/user-attachments/assets/dbeaf991-122b-495d-9761-1aa25712a049)
...
```
├── commands **[Contain bash command for ease of running experiments]**
...
```
python3 main.py --task car --algo-name cac
```
or
```
python3 main.py --task neurallander --algo-name cac-approx 
```

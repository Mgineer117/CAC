...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="cac", help="Disable cuda.")
    ...
    parser.add_argument(
        "--SDC-lr", type=float, default=None, help="Base learning rate."
    )
    ...
    parser.add_argument("--w-ub", type=float, default=10.0, help="Base learning rate.")
    parser.add_argument("--w-lb", type=float, default=1e-1, help="Base learning rate.")
    parser.add_argument(
        "--eps-clip", type=float, default=None, help="Base learning rate."
    )
    parser.add_argument("--eps", type=float, default=0.05, help="Base learning rate.")
    parser.add_argument("--lbd", type=float, default=0.5, help="Base learning rate.")
    parser.add_argument(
        "--DynamicLearner-dim",
        type=list,
        default=[256, 256],
    ...
    parser.add_argument(
        "--SDCLearner-dim", type=list, default=[256, 256], help="Base learning rate."
    )
    parser.add_argument(
